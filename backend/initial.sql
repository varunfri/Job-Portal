...
CREATE TABLE Company (
    email VARCHAR(255) PRIMARY qKEY,
...
('Devops engineer','Associate consultant architecture of software, Agile, Devops', 10, 'Architect', 'jav    a,spring,springbot,Azure,devops', 'comp@test');
